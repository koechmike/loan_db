...
$insert = mysqli_query($link, "INSERT INTO borrowers VALUES(null,'$fname','$lname','$email','$phone','$addrs1','$addrs2','$County','$Subcounty','$krapin','$country','$comment','$account','0.0','$location',NOW(),'$status')") or die (mysqli_error($link));
if(!$insert)
{
...
<fieldset style="width:270px">	
    ...
    <!-- <div class="form-group" style="margin-bottom: 1rem" class="row">
        <div class="col-md-6">
		 	<label for="" class="control-label" style="color:#009900">Account Number</label>
        </div>
        <div class="col-md-6">
			<input name="account" type="text" class="form-control" value="<?php echo $account; ?>" placeholder="Acc Number">
					<?php
    ...
    <div style="margin-bottom: 1rem" class="row">
        <div class="col-md-6">
			<label for="" class="control-label" style="color:#009900">Last Name</label>
        </div>
        <div class="col-md-6">
	...
	<div style="margin-bottom: 1rem" class="row">
        ...
        <div class="col-md-6">
			<input type="date" name="email" type="text" class="form-control" placeholder="Date of Birth">
        </div>
    </div>	
</fieldset>
</div>
...
<fieldset style="width:270px">	
    ...
    <div style="margin-bottom: 1rem" class="row">
        <div class="col-md-4">
            <label for="" class="control-label" style="color:#009900">P.O. Box</label>
        </div>
        <div class="col-md-8">
			<input name="lname" type="text" class="form-control" placeholder="P.O. Box" required>
        </div>
    </div>
	<div style="margin-bottom: 1rem" class="row">
        <div class="col-md-4">
